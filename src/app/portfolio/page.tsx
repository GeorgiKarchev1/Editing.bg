...
function PortfolioSection() {
  ...
  const portfolioItems = [
    ...
    },
    {
      ...
      category: 'YouTube',
      link: "https://www.youtube.com/watch?v=_KxDCwm3y50&t=95s",
    ...
    },
    {
      ...
      category: 'YouTube',
      link: "https://www.youtube.com/watch?v=VLfUdn4G2a8&t=99s",
    ...
    },
    {
      ...
      {
        id: 23,
        title: 'Добри дела от Fancy Point',
        category: 'Shorts',
        link: "https://youtube.com/shorts/n2Qt5oEANsc?feature=share",
        thumbnail: "/shortThumbs/Добри дела от Fancy Point.jpg",
        type: "video",
      },
      {
        id: 24,
        title: 'Рекламна компилация за KickHaven',
        category: 'Shorts',
        link: "https://youtube.com/shorts/DylrEkvnBI0?feature=share",
        thumbnail: "/shortThumbs/Рекламна компилация за KickHaven.jpg",
        type: "video",
      },
      {
        id: 25,
        title: 'Обувките на рапърите - Реклама за Kick Haven',
        category: 'Shorts',
        link: "https://youtube.com/shorts/QdhquzXHQ7Y?feature=share",
        thumbnail: "/shortThumbs/Обувките на рапърите - Реклама за Kick Haven.jpg",
        type: "video",
      },
      {
        id: 26,
        title: 'Реклама на четка за грим',
        category: 'Shorts',
        link: "https://youtube.com/shorts/Roo9puOsEAo?feature=share",
        thumbnail: "/shortThumbs/Реклама на четка за грим.jpg",
        type: "video",
      },
      {
        id: 27,
        title: 'Съобщението за следващия човек - Fancy Point',
        category: 'Shorts',
        link: "https://youtube.com/shorts/orvcnD9cxCA?feature=share",
        thumbnail: "/shortThumbs/Съобщението за следващия човек - Fancy Point.jpg",
        type: "video",
      },
      {
        id: 28,
        title: 'Предизвикателство за слушалки в Банско! Mr. Airpod',
        category: 'Shorts',
        link: "https://youtube.com/shorts/xCihq7OQ9rM?feature=share",
        thumbnail: "/shortThumbs/Предизвикателство за слушалки в Банско! Mr. Airpod.jpg",
        type: "video",
      },
      {
        id: 29,
        title: 'Откачени предизвикателства от Mr. Airpod',
        category: 'Shorts',
        link: "https://youtube.com/shorts/BJEDe1gDhw4?feature=share",
        thumbnail: "/shortThumbs/Откачени предизвикателства от Mr. Airpod.jpg",
        type: "video",
      },
      {
        id: 30,
        title: 'Сделка или не (4) - Fancy Point',
        category: 'Shorts',
        link: "https://youtube.com/shorts/A-kBV4G7yqY?feature=share",
        thumbnail: "/shortThumbs/Сделка или не (4) - Fancy Point.jpg",
        type: "video",
      },
      {
        id: 31,
        title: 'Щури предизвикателства от Mr. Airpod',
        category: 'Shorts',
        link: "https://youtube.com/shorts/92rVqJHea_c?feature=share",
        thumbnail: "/shortThumbs/Щури предизвикателства от Mr. Airpod.jpg",
        type: "video",
      },
      {
        id: 32,
        title: 'Реклама с озвучаване за Mr. Airpod',
        category: 'Shorts',
        link: "https://youtube.com/shorts/AOPXKTPg4Wo?feature=share",
        thumbnail: "/shortThumbs/Реклама с озвучаване за Mr. Airpod.jpg",
        type: "video",
      },
      {
        id: 33,
        title: 'Реклама - editing.bg',
        category: 'Shorts',
        link: "https://youtube.com/shorts/Fhg9d1HDB-Y?feature=share",
        thumbnail: "/shortThumbs/Реклама - editing.bg.jpg",
        type: "video",
      },
      {
        id: 34,
        title: 'Vonster познава YouTube създатели по рисунки',
        category: 'Shorts',
        link: "https://youtube.com/shorts/VhJPdBs1Shk?feature=share",
        thumbnail: "/shortThumbs/Vonster познава YouTube създатели по рисунки.jpg",
        type: "video",
      },
      {
        id: 35,
        title: '17 часа обработка по документация',
        category: 'Shorts',
        link: "https://youtube.com/shorts/j-mS9d3jeps?feature=share",
        thumbnail: "/shortThumbs/17 часа обработка по документация.jpg",
        type: "video",
      },
      {
        id: 36,
        title: 'Инфлуенсърите за KickHaven',
        category: 'Shorts',
        link: "https://youtube.com/shorts/ZjuDpFkBIkU?feature=share",
        thumbnail: "/shortThumbs/Инфлуенсърите за KickHaven.jpg",
        type: "video",
      },
      {
        id: 37,
        title: 'Реклама на Бранд за обувки KickHaven',
        category: 'Shorts',
        link: "https://youtube.com/shorts/BUzaor1Vvb4?feature=share",
        thumbnail: "/shortThumbs/Реклама на Бранд за обувки KickHaven.jpg",
        type: "video",
      },
      {
        id: 38,
        title: 'Динамична реклама на Бранд за Дрехи moskitomoda',
        category: 'Shorts',
        link: "https://youtube.com/shorts/UY6vk1UMRVE?feature=share",
        thumbnail: "/shortThumbs/Динамична реклама на Бранд за Дрехи moskitomoda.jpg",
        type: "video",
      },
      {
        id: 39,
        title: 'Реклама на жилибони за приспиване',
        category: 'Shorts',
        link: "https://youtube.com/shorts/xU27GqeisKw?feature=share",
        thumbnail: "/shortThumbs/Реклама на жилибони за приспиване.jpg",
        type: "video",
      },
      {
        id: 40,
        title: 'Сделка или не (1) - Fancy Point',
        category: 'Shorts',
        link: "https://youtube.com/shorts/YfVR351V0C8?feature=share",
        thumbnail: "/shortThumbs/Сделка или не (1) - Fancy Point.jpg",
        type: "video",
      },
      {
        id: 41,
        title: 'Сделка или не (2) - Fancy Point',
        category: 'Shorts',
        link: "https://youtube.com/shorts/Bqf-EBH_TwQ?feature=share",
        thumbnail: "/shortThumbs/Сделка или не (2) - Fancy Point.jpg",
        type: "video",
      },
      {
        id: 42,
        title: 'Сделка или не (3) - Fancy Point',
        category: 'Shorts',
        link: "https://youtube.com/shorts/Ex-uu7sTe9c?feature=share",
        thumbnail: "/shortThumbs/Сделка или не (3) - Fancy Point.jpg",
        type: "video",
      },
  ]
