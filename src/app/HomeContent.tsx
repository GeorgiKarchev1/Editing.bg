      ...
      >
        ...
        >
          <div className="aspect-video bg-dark-card rounded-lg xs:rounded-xl sm:rounded-2xl glow-border overflow-hidden relative">
            <iframe
              src="https://www.youtube.com/embed/YnYuRHKYO-Q?autoplay=1&mute=0&controls=1&showinfo=0&rel=0&modestbranding=1&loop=1&playlist=YnYuRHKYO-Q&start=0"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
        ...
        >
          ...
          <div>
            ...
            <p className="text-gray-300 text-lg mb-8 max-w-lg mx-auto leading-relaxed">
              Основател и CEO/COO на Editing.bg, водещ креативната визия и бизнес стратегия.
        ...
        >
          ...
          <div>
            ...
            <p className="text-gray-300 text-lg mb-8 max-w-lg mx-auto leading-relaxed">
              Технически директор на Editing.bg, комбиниращ най-съвременните технологии с творческо съвършенство за постигане на максимална ефективност.
            </p>
